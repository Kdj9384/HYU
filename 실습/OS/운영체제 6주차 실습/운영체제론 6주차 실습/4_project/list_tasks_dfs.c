...
void dfs(struct task_struct *task)
{
  ...
  list_for_each_entry(cursor, task->sibling, sibling)
  {

    dfs(list_entry(ptr, task_struct *, task->pid));
  }
}
